  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify pod roles with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "kickoff-script",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify kickoff script with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "weekly-rituals",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify weekly rituals with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "handoff-ceremony",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify handoff ceremony with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
